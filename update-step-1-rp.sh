...
if [ -f /usr/lib/libz.so.1.2.8 ] ; then
    cp -p /usr/lib/libz.so.1.2.8 /tmp/tmproot/usr/lib/ || true
    ln -s /usr/lib/libz.so.1.2.8 /tmp/tmproot/usr/lib/libz.so.1 || true
    ln -s /usr/lib/libz.so.1.2.8 /tmp/tmproot/usr/lib/libz.so
else
    cp -p /usr/lib/libz.so.1.2.11 /tmp/tmproot/usr/lib/ || true
    ln -s /usr/lib/libz.so.1.2.11 /tmp/tmproot/usr/lib/libz.so.1 || true
    ln -s /usr/lib/libz.so.1.2.11 /tmp/tmproot/usr/lib/libz.so
fi
if [ -f /usr/lib/libstdc++.so.6.0.20 ] ; then
    cp -p /usr/lib/libstdc++.so.6.0.20 /tmp/tmproot/usr/lib/
    ln -s /usr/lib/libstdc++.so.6.0.20 /tmp/tmproot/usr/lib/libstdc++.so.6
fi
cp -p /usr/lib/libSDL-1.2.so.0 /tmp/tmproot/usr/lib/
ln -s /usr/lib/libstdc++.so.6.0.20 /tmp/tmproot/usr/lib/libSDL-1.2.so.0.11.4

cp -p /usr/lib/libKeLibTxt.so /tmp/tmproot/usr/lib/
cp -p /usr/lib/libMotorIOLib.so /tmp/tmproot/usr/lib/
cp -p /usr/lib/libROBOProLib.so /tmp/tmproot/usr/lib/
cp -p /usr/lib/libSDLWidgetsLib.so /tmp/tmproot/usr/lib/
cp -p /usr/lib/libTxtControlLib.so /tmp/tmproot/usr/lib/

cp -p /use/lib/libSDL_gfx.so.13.9.1 /tmp/tmproot/usr/lib/
ln -s /usr/lib/libSDL_gfx.so.13 /tmp/tmproot/usr/lib/libSDL_gfx.so.13.9.1
ln -s /usr/lib/libSDL_gfx.so /tmp/tmproot/usr/lib/libSDL_gfx.so.13.9.1
